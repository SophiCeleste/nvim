  ...
  --[[
  {
    ...
    config = function()
      require('watermelon').setup {
        ...
        ---- Toggle theme style ---
        toggle_style_key = nil,         --- keybind to toggle theme style. Leave it nil to disable it, or set it to a string, for example "<leader>ts"
        toggle_style_list = { 'dark' }, --- List of styles to toggle between
...
--- Diagnostic keymaps
vim.diagnostic.config({ virtual_text = true }) -- Enables inline diagnostic messages
...
vim.api.nvim_create_autocmd('FileType', {
  ...
  callback = function()
    ...
    -- Optional: wrap at work poundaries rather than middle of words
...
--- Save folds and cursor posititon
